<form method="post" class='pt-2 px-4 max-w-[480px] grid grid-cols-[320px_auto] gap-4 items-center'>
  <input required <?= ($_GET['id'] ?? false) ? null : 'autofocus' ?> type='text' placeholder="category name" id='name'
    name='name' class='block w-[min(100%,60ch)] rounded-md border-2 border-slate-500 px-4 py-1 text-lg' />
          ...
          <div class='flex items-center gap-2'>
            ...
            <a href="?id=<?= $category['id'] ?>" name="edit" title='edit category'
              ...
              <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024"
                class="text-xl text-slate-600 transition" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <button type='submit' name="delete_category" value="<?= $category['id'] ?>" title='delete category'
